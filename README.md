# 🎙️ Live Captions - Accessibility App for SIH 2025

> **Smart Accessibility Solution for Deaf & Hard-of-Hearing Users**  
> Real-time speech-to-text with intelligent simplification and system-wide floating captions
...
**Live Captions** is an innovative accessibility application designed specifically for **Deaf and Hard-of-Hearing users** in India. The app provides real-time speech-to-text conversion with intelligent text simplification across 15 Indian languages, featuring a revolutionary **system-wide floating caption overlay** that works across all apps.
